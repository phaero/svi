...
G_MODULE_EXPORT gboolean on_exit_clicked(GtkWidget* UP(widget), gpointer UP(gdata))
{
	main_status.quitting = TRUE;
...
G_MODULE_EXPORT void on_new1_activate(GtkMenuItem* UP(menuitem), gpointer UP(user_data))
{
	document_new_file(NULL, NULL, NULL);
}


G_MODULE_EXPORT void on_save1_activate(GtkMenuItem* UP(menuitem), gpointer UP(user_data))
{
...
G_MODULE_EXPORT void on_save_as1_activate(GtkMenuItem* UP(menuitem), gpointer UP(user_data))
{
	dialogs_show_save_as();
}


G_MODULE_EXPORT void on_save_all1_activate(GtkMenuItem* UP(menuitem), gpointer UP(user_data))
{
...
G_MODULE_EXPORT void on_close_all1_activate(GtkMenuItem* UP(menuitem), gpointer UP(user_data))
{
	document_close_all();
}


G_MODULE_EXPORT void on_close1_activate(GtkMenuItem* UP(menuitem), gpointer UP(user_data))
{
	GeanyDocument *doc = document_get_current();
...
G_MODULE_EXPORT void on_quit1_activate(GtkMenuItem* UP(menuitem), gpointer UP(user_data))
{
	on_exit_clicked(NULL, NULL);
}


G_MODULE_EXPORT void on_file1_activate(GtkMenuItem* UP(menuitem), gpointer UP(user_data))
{
...
G_MODULE_EXPORT void on_edit1_activate(GtkMenuItem* UP(menuitem), gpointer UP(user_data))
{
	GtkWidget *item;
	GeanyDocument *doc = document_get_current();
...
G_MODULE_EXPORT void on_undo1_activate(GtkMenuItem* UP(menuitem), gpointer UP(user_data))
{
	GeanyDocument *doc = document_get_current();
...
G_MODULE_EXPORT void on_redo1_activate(GtkMenuItem* UP(menuitem), gpointer UP(user_data))
{
	GeanyDocument *doc = document_get_current();
...
G_MODULE_EXPORT void on_cut1_activate(GtkMenuItem* UP(menuitem), gpointer UP(user_data))
{
	GeanyDocument *doc = document_get_current();
...
G_MODULE_EXPORT void on_copy1_activate(GtkMenuItem* UP(menuitem), gpointer UP(user_data))
{
	GeanyDocument *doc = document_get_current();
	GtkWidget *focusw = gtk_window_get_focus(GTK_WINDOW(main_widgets.window));
...
G_MODULE_EXPORT void on_paste1_activate(GtkMenuItem* UP(menuitem), gpointer UP(user_data))
{
	GeanyDocument *doc = document_get_current();
	GtkWidget *focusw = gtk_window_get_focus(GTK_WINDOW(main_widgets.window));
...
G_MODULE_EXPORT void on_delete1_activate(GtkMenuItem* UP(menuitem), gpointer UP(user_data))
{
	GeanyDocument *doc = document_get_current();
	GtkWidget *focusw = gtk_window_get_focus(GTK_WINDOW(main_widgets.window));
...
G_MODULE_EXPORT void on_preferences1_activate(GtkMenuItem* UP(menuitem), gpointer UP(user_data))
{
	prefs_show_dialog();
}
...
/* about menu item */
G_MODULE_EXPORT void on_info1_activate(GtkMenuItem* UP(menuitem), gpointer UP(user_data))
{
	about_dialog_show();
}
...
/* open file */
G_MODULE_EXPORT void on_open1_activate(GtkMenuItem* UP(menuitem), gpointer UP(user_data))
{
...
/* quit toolbar button */
G_MODULE_EXPORT void on_toolbutton_quit_clicked(GtkAction* UP(action), gpointer UP(user_data))
{
	on_exit_clicked(NULL, NULL);
}
...
/* reload file */
G_MODULE_EXPORT void on_toolbutton_reload_clicked(GtkAction* UP(action), gpointer UP(user_data))
{
...
G_MODULE_EXPORT void on_reload_as_activate(GtkMenuItem* UP(menuitem), gpointer user_data)
{
	GeanyDocument *doc = document_get_current();
	gchar *base_name;
...
G_MODULE_EXPORT void on_change_font1_activate(GtkMenuItem* UP(menuitem), gpointer UP(user_data))
{
...
/* new file */
G_MODULE_EXPORT void on_toolbutton_new_clicked(GtkAction* UP(action), gpointer UP(user_data))
{
	document_new_file(NULL, NULL, NULL);
}
...
/* open file */
G_MODULE_EXPORT void on_toolbutton_open_clicked(GtkAction* UP(action), gpointer UP(user_data))
{
	dialogs_show_open_file();
}
...
/* save file */
G_MODULE_EXPORT void on_toolbutton_save_clicked(GtkAction* UP(action), gpointer user_data)
{
...
/* search text */
G_MODULE_EXPORT void on_toolbar_search_entry_changed(GtkAction* UP(action),
		const gchar *text, gpointer UP(user_data))
{
...
/* search text */
G_MODULE_EXPORT void on_toolbar_search_entry_activate(GtkAction* UP(action),
...
/* search text */
G_MODULE_EXPORT void on_toolbutton_search_clicked(GtkAction* UP(action), gpointer UP(user_data))
{
	GeanyDocument *doc = document_get_current();
	gboolean result;
...
G_MODULE_EXPORT void on_hide_toolbar1_activate(GtkMenuItem* UP(menuitem), gpointer UP(user_data))
{
...
G_MODULE_EXPORT void on_zoom_in1_activate(GtkMenuItem* UP(menuitem), gpointer UP(user_data))
{
	GeanyDocument *doc = document_get_current();
	static gint done = 1;
...
G_MODULE_EXPORT void on_zoom_out1_activate(GtkMenuItem* UP(menuitem), gpointer UP(user_data))
{
	GeanyDocument *doc = document_get_current();
...
G_MODULE_EXPORT void on_normal_size1_activate(GtkMenuItem* UP(menuitem), gpointer UP(user_data))
{
	GeanyDocument *doc = document_get_current();
...
/* close tab */
G_MODULE_EXPORT void on_toolbutton_close_clicked(GtkAction* UP(action), gpointer UP(user_data))
{
	on_close1_activate(NULL, NULL);
}


G_MODULE_EXPORT void on_toolbutton_close_all_clicked(GtkAction* UP(action), gpointer UP(user_data))
{
	on_close_all1_activate(NULL, NULL);
}


G_MODULE_EXPORT void on_toolbutton_preferences_clicked(GtkAction* UP(action), gpointer UP(user_data))
{
...
G_MODULE_EXPORT void on_notebook1_switch_page_after(GtkNotebook* UP(notebook),
		GtkNotebookPage *page, guint page_num, gpointer UP(user_data))
{
	GeanyDocument *doc;
...
G_MODULE_EXPORT void on_tv_notebook_switch_page(GtkNotebook* UP(notebook),
		GtkNotebookPage* UP(page), guint UP(page_num), gpointer UP(user_data))
{
...
G_MODULE_EXPORT void on_tv_notebook_switch_page_after(GtkNotebook* UP(notebook),
		GtkNotebookPage* UP(page), guint UP(page_num), gpointer UP(user_data))
{
...
G_MODULE_EXPORT void on_crlf_activate(GtkCheckMenuItem *menuitem, gpointer UP(user_data))
{
...
G_MODULE_EXPORT void on_lf_activate(GtkCheckMenuItem *menuitem, gpointer UP(user_data))
{
	if (ignore_callback || ! gtk_check_menu_item_get_active(menuitem))
		return;
...
G_MODULE_EXPORT void on_cr_activate(GtkCheckMenuItem *menuitem, gpointer UP(user_data))
{
	if (ignore_callback || ! gtk_check_menu_item_get_active(menuitem))
		return;
...
G_MODULE_EXPORT void on_replace_tabs_activate(GtkMenuItem* UP(menuitem), gpointer UP(user_data))
{
	GeanyDocument *doc = document_get_current();
...
gboolean toolbar_popup_menu(GtkWidget* UP(widget), GdkEventButton *event, gpointer UP(user_data))
{
	if (event->button == 3)
	{
...
G_MODULE_EXPORT void on_toggle_case1_activate(GtkMenuItem* UP(menuitem), gpointer UP(user_data))
{
	GeanyDocument *doc = document_get_current();
	ScintillaObject *sci;
	gchar *text;
...
G_MODULE_EXPORT void on_show_toolbar1_toggled(GtkCheckMenuItem* UP(checkmenuitem),
...
G_MODULE_EXPORT void on_fullscreen1_toggled(GtkCheckMenuItem* UP(checkmenuitem),
		gpointer UP(user_data))
{
	if (ignore_callback)
		return;
...
G_MODULE_EXPORT void on_show_messages_window1_toggled(GtkCheckMenuItem* UP(checkmenuitem),
		gpointer UP(user_data))
{
	if (ignore_callback)
		return;
...
G_MODULE_EXPORT void on_markers_margin1_toggled(GtkCheckMenuItem* UP(checkmenuitem),
		gpointer UP(user_data))
{
	if (ignore_callback)
		return;
...
G_MODULE_EXPORT void on_show_line_numbers1_toggled(GtkCheckMenuItem* UP(checkmenuitem),
		gpointer UP(user_data))
{
	if (ignore_callback)
		return;
...
G_MODULE_EXPORT void on_menu_show_white_space1_toggled(GtkCheckMenuItem* UP(checkmenuitem),
		gpointer UP(user_data))
{
	if (ignore_callback)
		return;
...
G_MODULE_EXPORT void on_menu_show_line_endings1_toggled(GtkCheckMenuItem* UP(checkmenuitem),
		gpointer UP(user_data))
{
	if (ignore_callback)
		return;
...
G_MODULE_EXPORT void on_menu_show_indentation_guides1_toggled(GtkCheckMenuItem* UP(checkmenuitem),
		gpointer UP(user_data))
{
	if (ignore_callback)
		return;
...
G_MODULE_EXPORT void on_line_wrapping1_toggled(GtkCheckMenuItem* UP(checkmenuitem),
		gpointer UP(user_data))
{
	if (! ignore_callback)
	{
...
G_MODULE_EXPORT void on_set_file_readonly1_toggled(GtkCheckMenuItem* UP(checkmenuitem),
		gpointer UP(user_data))
{
	if (! ignore_callback)
	{
...
G_MODULE_EXPORT void on_use_auto_indentation1_toggled(GtkCheckMenuItem* UP(checkmenuitem),
		gpointer UP(user_data))
{
	if (! ignore_callback)
	{
...
G_MODULE_EXPORT void on_find_document_usage1_activate(GtkMenuItem* UP(menuitem),
		gpointer UP(user_data))
{
	find_usage(FALSE);
}
...
G_MODULE_EXPORT void on_find_usage1_activate(GtkMenuItem* UP(menuitem),
		gpointer UP(user_data))
{
	find_usage(TRUE);
}
...
G_MODULE_EXPORT void on_goto_tag_definition1(GtkMenuItem* UP(menuitem),
		gpointer UP(user_data))
{
	goto_tag(TRUE);
}
...
G_MODULE_EXPORT void on_goto_tag_declaration1(GtkMenuItem* UP(menuitem),
		gpointer UP(user_data))
{
	goto_tag(FALSE);
}
...
G_MODULE_EXPORT void on_count_words1_activate(GtkMenuItem* UP(menuitem),
		gpointer UP(user_data))
{
	tools_word_count();
}
...
G_MODULE_EXPORT void on_show_color_chooser1_activate(GtkMenuItem* UP(menuitem),
		gpointer UP(user_data))
{
	gchar colour[9];
	GeanyDocument *doc = document_get_current();
...
G_MODULE_EXPORT void on_toolbutton_compile_clicked(GtkAction* UP(action),
		gpointer UP(user_data))
{
...
G_MODULE_EXPORT void on_find1_activate(GtkMenuItem* UP(menuitem),
		gpointer UP(user_data))
{
...
G_MODULE_EXPORT void on_find_next1_activate(GtkMenuItem* UP(menuitem),
		gpointer UP(user_data))
{
...
G_MODULE_EXPORT void on_find_previous1_activate(GtkMenuItem* UP(menuitem),
		gpointer UP(user_data))
{
...
G_MODULE_EXPORT void on_find_nextsel1_activate(GtkMenuItem* UP(menuitem),
		gpointer UP(user_data))
{
...
G_MODULE_EXPORT void on_find_prevsel1_activate(GtkMenuItem* UP(menuitem),
		gpointer UP(user_data))
{
...
G_MODULE_EXPORT void on_replace1_activate(GtkMenuItem* UP(menuitem),
		gpointer UP(user_data))
{
...
G_MODULE_EXPORT void on_find_in_files1_activate(GtkMenuItem* UP(menuitem),
		gpointer UP(user_data))
{
...
G_MODULE_EXPORT void on_go_to_line_activate(GtkMenuItem* UP(menuitem),
		gpointer UP(user_data))
{
...
G_MODULE_EXPORT void on_toolbutton_goto_entry_activate(GtkAction* UP(action),
		const gchar *text, gpointer UP(user_data))
{
	GeanyDocument *doc = document_get_current();
	gint offset;
...
G_MODULE_EXPORT void on_toolbutton_goto_clicked(GtkAction* UP(action),
		gpointer UP(user_data))
{
...
G_MODULE_EXPORT void on_help1_activate(GtkMenuItem* UP(menuitem),
		gpointer UP(user_data))
{
	gchar *uri;
...
G_MODULE_EXPORT void on_help_shortcuts1_activate(GtkMenuItem* UP(menuitem),
		gpointer UP(user_data))
{
...
G_MODULE_EXPORT void on_website1_activate(GtkMenuItem* UP(menuitem),
		gpointer UP(user_data))
{
...
G_MODULE_EXPORT void on_help_menu_item_donate_activate(GtkMenuItem* UP(item),
		gpointer UP(user_data))
{
...
G_MODULE_EXPORT void on_help_menu_item_wiki_activate(GtkMenuItem* UP(item), gpointer UP(user_data))
{
	utils_open_browser(GEANY_WIKI);
}


G_MODULE_EXPORT void on_help_menu_item_bug_report_activate(GtkMenuItem* UP(item),
		gpointer UP(user_data))
{
...
G_MODULE_EXPORT void on_comments_function_activate(GtkMenuItem* UP(menuitem),
		gpointer UP(user_data))
{
	GeanyDocument *doc = document_get_current();
	gchar *text;
...
G_MODULE_EXPORT void on_comments_multiline_activate(GtkMenuItem* UP(menuitem),
		gpointer UP(user_data))
{
	GeanyDocument *doc = document_get_current();
...
G_MODULE_EXPORT void on_comments_gpl_activate(GtkMenuItem* UP(menuitem),
		gpointer UP(user_data))
{
	GeanyDocument *doc = document_get_current();
	gchar *text;
...
G_MODULE_EXPORT void on_comments_bsd_activate(GtkMenuItem* UP(menuitem),
		gpointer UP(user_data))
{
	GeanyDocument *doc = document_get_current();
	gchar *text;
...
G_MODULE_EXPORT void on_comments_changelog_activate(GtkMenuItem* UP(menuitem),
		gpointer UP(user_data))
{
	GeanyDocument *doc = document_get_current();
	gchar *text;
...
G_MODULE_EXPORT void on_comments_fileheader_activate(GtkMenuItem* UP(menuitem),
		gpointer UP(user_data))
{
	GeanyDocument *doc = document_get_current();
	gchar *text;
...
G_MODULE_EXPORT void on_insert_date_activate(GtkMenuItem* UP(menuitem),
		gpointer user_data)
{
	GeanyDocument *doc = document_get_current();
...
G_MODULE_EXPORT void on_insert_include_activate(GtkMenuItem* UP(menuitem),
		gpointer user_data)
{
	GeanyDocument *doc = document_get_current();
	gint pos = -1;
...
G_MODULE_EXPORT void on_file_properties_activate(GtkMenuItem* UP(menuitem),
		gpointer UP(user_data))
{
	GeanyDocument *doc = document_get_current();
	g_return_if_fail(doc != NULL);
...
G_MODULE_EXPORT void on_menu_fold_all1_activate(GtkMenuItem* UP(menuitem),
		gpointer UP(user_data))
{
	GeanyDocument *doc = document_get_current();
	g_return_if_fail(doc != NULL);
...
G_MODULE_EXPORT void on_menu_unfold_all1_activate(GtkMenuItem* UP(menuitem),
		gpointer UP(user_data))
{
	GeanyDocument *doc = document_get_current();
	g_return_if_fail(doc != NULL);
...
G_MODULE_EXPORT void on_toolbutton_run_clicked(GtkAction* UP(action),
		gpointer UP(user_data))
{
...
G_MODULE_EXPORT void on_menu_remove_indicators1_activate(GtkMenuItem* UP(menuitem),
		gpointer UP(user_data))
{
	GeanyDocument *doc = document_get_current();
	g_return_if_fail(doc != NULL);
...
G_MODULE_EXPORT void on_print1_activate(GtkMenuItem* UP(menuitem),
		gpointer UP(user_data))
{
	GeanyDocument *doc = document_get_current();
	g_return_if_fail(doc != NULL);
...
G_MODULE_EXPORT void on_menu_select_all1_activate(GtkMenuItem* UP(menuitem),
		gpointer UP(user_data))
{
	GeanyDocument *doc = document_get_current();
	g_return_if_fail(doc != NULL);
...
G_MODULE_EXPORT void on_menu_show_sidebar1_toggled(GtkCheckMenuItem* UP(checkmenuitem),
		gpointer UP(user_data))
{
	if (ignore_callback)
		return;
...
G_MODULE_EXPORT void on_menu_write_unicode_bom1_toggled(GtkCheckMenuItem* UP(checkmenuitem),
		gpointer UP(user_data))
{
	if (! ignore_callback)
	{
...
G_MODULE_EXPORT void on_menu_comment_line1_activate(GtkMenuItem* UP(menuitem),
		gpointer UP(user_data))
{
	GeanyDocument *doc = document_get_current();
	g_return_if_fail(doc != NULL);
...
G_MODULE_EXPORT void on_menu_uncomment_line1_activate(GtkMenuItem* UP(menuitem),
		gpointer UP(user_data))
{
	GeanyDocument *doc = document_get_current();
	g_return_if_fail(doc != NULL);
...
G_MODULE_EXPORT void on_menu_toggle_line_commentation1_activate(GtkMenuItem* UP(menuitem),
		gpointer UP(user_data))
{
	GeanyDocument *doc = document_get_current();
	g_return_if_fail(doc != NULL);
...
G_MODULE_EXPORT void on_menu_increase_indent1_activate(GtkMenuItem* UP(menuitem),
		gpointer UP(user_data))
{
	GeanyDocument *doc = document_get_current();
	g_return_if_fail(doc != NULL);
...
G_MODULE_EXPORT void on_menu_decrease_indent1_activate(GtkMenuItem* UP(menuitem),
		gpointer UP(user_data))
{
	GeanyDocument *doc = document_get_current();
	g_return_if_fail(doc != NULL);
...
G_MODULE_EXPORT void on_next_message1_activate(GtkMenuItem* UP(menuitem),
		gpointer UP(user_data))
{
...
G_MODULE_EXPORT void on_previous_message1_activate(GtkMenuItem* UP(menuitem),
		gpointer UP(user_data))
{
...
G_MODULE_EXPORT void on_project_new1_activate(GtkMenuItem* UP(menuitem),
		gpointer UP(user_data))
{
	project_new();
}
...
G_MODULE_EXPORT void on_project_open1_activate(GtkMenuItem* UP(menuitem),
		gpointer UP(user_data))
{
	project_open();
}
...
G_MODULE_EXPORT void on_project_close1_activate(GtkMenuItem* UP(menuitem),
		gpointer UP(user_data))
{
	project_close(TRUE);
}
...
G_MODULE_EXPORT void on_project_properties1_activate(GtkMenuItem* UP(menuitem),
		gpointer UP(user_data))
{
	project_properties();
}
...
G_MODULE_EXPORT void on_menu_project1_activate(GtkMenuItem* UP(menuitem),
		gpointer UP(user_data))
{
...
G_MODULE_EXPORT void on_menu_open_selected_file1_activate(GtkMenuItem* UP(menuitem),
		gpointer UP(user_data))
{
	GeanyDocument *doc = document_get_current();
	gchar *sel = NULL;
...
G_MODULE_EXPORT void on_remove_markers1_activate(GtkMenuItem* UP(menuitem),
		gpointer UP(user_data))
{
	GeanyDocument *doc = document_get_current();
	g_return_if_fail(doc != NULL);
...
G_MODULE_EXPORT void on_load_tags1_activate(GtkMenuItem* UP(menuitem),
		gpointer UP(user_data))
{
...
G_MODULE_EXPORT void on_context_action1_activate(GtkMenuItem* UP(menuitem),
		gpointer UP(user_data))
{
	gchar *word, *command;
	GError *error = NULL;
...
G_MODULE_EXPORT void on_menu_toggle_all_additional_widgets1_activate(
		GtkMenuItem* UP(menuitem), gpointer UP(user_data))
{
...
G_MODULE_EXPORT void on_forward_activate(GtkMenuItem* UP(menuitem),
		gpointer UP(user_data))
{
	navqueue_go_forward();
}
...
G_MODULE_EXPORT void on_back_activate(GtkMenuItem* UP(menuitem),
		gpointer UP(user_data))
{
	navqueue_go_back();
}
...
G_MODULE_EXPORT gboolean on_motion_event(GtkWidget *widget, GdkEventMotion* UP(event),
		gpointer UP(user_data))
{
...
G_MODULE_EXPORT void on_tabs1_activate(GtkCheckMenuItem *menuitem,
		gpointer UP(user_data))
{
...
G_MODULE_EXPORT void on_spaces1_activate(GtkCheckMenuItem *menuitem,
		gpointer UP(user_data))
{
...
G_MODULE_EXPORT void on_tabs_and_spaces1_activate(GtkCheckMenuItem *menuitem,
		gpointer UP(user_data))
{
...
G_MODULE_EXPORT void on_strip_trailing_spaces1_activate(GtkMenuItem* UP(menuitem),
		gpointer UP(user_data))
{
	GeanyDocument *doc;
...
G_MODULE_EXPORT void on_page_setup1_activate(GtkMenuItem* UP(menuitem),
		gpointer UP(user_data))
{
...
G_MODULE_EXPORT gboolean on_escape_key_press_event(GtkWidget* UP(widget),
		GdkEventKey *event, gpointer UP(user_data))
{
...
G_MODULE_EXPORT void on_line_breaking1_activate(GtkMenuItem* UP(menuitem),
		gpointer UP(user_data))
{
	GeanyDocument *doc;
...
G_MODULE_EXPORT void on_replace_spaces_activate(GtkMenuItem* UP(menuitem),
		gpointer UP(user_data))
{
	GeanyDocument *doc = document_get_current();
...
G_MODULE_EXPORT void on_search1_activate(GtkMenuItem* UP(menuitem),
		gpointer UP(user_data))
{
...
G_MODULE_EXPORT void on_close_other_documents1_activate(GtkMenuItem* UP(menuitem), gpointer user_data)
{
	guint i;
...
G_MODULE_EXPORT void on_menu_reload_configuration1_activate(GtkMenuItem* UP(menuitem),
		gpointer UP(user_data))
{
...
G_MODULE_EXPORT void on_debug_messages1_activate(GtkMenuItem* UP(menuitem),
		gpointer UP(user_data))
{
...
G_MODULE_EXPORT void on_send_selection_to_vte1_activate(GtkMenuItem* UP(menuitem),
		gpointer UP(user_data))
{
#ifdef HAVE_VTE
...
G_MODULE_EXPORT gboolean on_window_state_event(GtkWidget* widget,
		GdkEventWindowState *event, gpointer UP(user_data))
{
...
G_MODULE_EXPORT void on_customize_toolbar1_activate(GtkMenuItem* UP(menuitem),
		gpointer UP(user_data))
{
	prefs_show_dialog();
...
G_MODULE_EXPORT void on_button_customize_toolbar_clicked(GtkButton* UP(button),
		gpointer UP(user_data))
{
...
G_MODULE_EXPORT void on_cut_current_lines1_activate(GtkMenuItem* UP(menuitem),
		gpointer UP(user_data))
{
...
G_MODULE_EXPORT void on_copy_current_lines1_activate(GtkMenuItem* UP(menuitem),
		gpointer UP(user_data))
{
...
G_MODULE_EXPORT void on_delete_current_lines1_activate(GtkMenuItem* UP(menuitem),
		gpointer UP(user_data))
{
...
G_MODULE_EXPORT void on_duplicate_line_or_selection1_activate(GtkMenuItem* UP(menuitem),
		gpointer UP(user_data))
{
...
G_MODULE_EXPORT void on_select_current_lines1_activate(GtkMenuItem* UP(menuitem),
		gpointer UP(user_data))
{
...
G_MODULE_EXPORT void on_select_current_paragraph1_activate(GtkMenuItem* UP(menuitem),
		gpointer UP(user_data))
{
...
G_MODULE_EXPORT void on_insert_alternative_white_space1_activate(GtkMenuItem* UP(menuitem),
		gpointer UP(user_data))
{
...
G_MODULE_EXPORT void on_go_to_next_marker1_activate(GtkMenuItem* UP(menuitem),
		gpointer UP(user_data))
{
...
G_MODULE_EXPORT void on_go_to_previous_marker1_activate(GtkMenuItem* UP(menuitem),
		gpointer UP(user_data))
{
...
G_MODULE_EXPORT void on_reflow_lines_block1_activate(GtkMenuItem* UP(menuitem),
		gpointer UP(user_data))
{
...
G_MODULE_EXPORT void on_transpose_current_line1_activate(GtkMenuItem* UP(menuitem),
		gpointer UP(user_data))
{
...
G_MODULE_EXPORT void on_smart_line_indent1_activate(GtkMenuItem* UP(menuitem),
		gpointer UP(user_data))
{
...
G_MODULE_EXPORT void on_plugin_preferences1_activate(GtkMenuItem* UP(menuitem),
		gpointer UP(user_data))
{
#ifdef HAVE_PLUGINS
...
G_MODULE_EXPORT void on_indent_width_activate(GtkMenuItem* menuitem,
		gpointer UP(user_data))
{
	GeanyDocument *doc;
	gchar *label;
...
G_MODULE_EXPORT void on_reset_indentation1_activate(GtkMenuItem* UP(menuitem),
		gpointer UP(user_data))
{
	guint i;
...
G_MODULE_EXPORT void on_mark_all1_activate(GtkMenuItem* UP(menuitem),
		gpointer UP(user_data))
{
...
G_MODULE_EXPORT void on_detect_type_from_file_activate(GtkMenuItem* UP(menuitem),
		gpointer UP(user_data))
{
	GeanyDocument *doc = document_get_current();
...
G_MODULE_EXPORT void on_detect_width_from_file_activate(GtkMenuItem* UP(menuitem),
		gpointer UP(user_data))
{
	GeanyDocument *doc = document_get_current();
	gint width;
